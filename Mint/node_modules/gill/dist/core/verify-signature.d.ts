import { type Address, type ReadonlyUint8Array, type Signature, type SignatureBytes } from "@solana/kit";
/**
 ...
 * ```
 */
export declare function verifySignatureForAddress(address: Address, signature: string | Signature | SignatureBytes | Uint8Array | ReadonlyUint8Array, message: string | Uint8Array): Promise<boolean>;
