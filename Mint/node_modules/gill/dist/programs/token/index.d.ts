import { Address, TransactionSigner, Account, Rpc, GetTokenAccountsByOwnerApi, GetAccountInfoApi, KeyPairSigner, Instruction, TransactionVersion, TransactionMessageWithBlockhashLifetime, TransactionMessageWithFeePayer } from '@solana/kit';
...
import { S as Simplify, C as CreateTransactionInput, F as FullTransaction } from '../../index-M7AUC0es.js';
...
declare function assertIsMint<TAddress extends string = string>(accountOrAddress: Account<Mint, TAddress> | Address<TAddress>): asserts accountOrAddress is Account<Mint, TAddress>;

type OriginalConfigParam = NonNullable<Parameters<GetTokenAccountsByOwnerApi["getTokenAccountsByOwner"]>[2]>;
type FetchTokenAccountsConfig = Simplify<Omit<OriginalConfigParam, "encoding"> & {
 ...
 * ```
 */
declare function fetchTokenAccounts<TMintAddress extends string = string, TOwner extends string = string>(rpc: Rpc<GetTokenAccountsByOwnerApi & GetAccountInfoApi>, mint: Address<TMintAddress> | Account<Mint>, owner: Address<TOwner>, config?: FetchTokenAccountsConfig): Promise<{
 ...
 */
declare function getCreateTokenInstructions(args: GetCreateTokenInstructionsArgs): Instruction[];
 ...
 * ```
 */
declare function getMintTokensInstructions(args: GetMintTokensInstructionsArgs): Instruction[];
 ...
 * ```
 */
declare function getTransferTokensInstructions(args: GetTransferTokensInstructionsArgs): Instruction[];
 ...
 * ```
 */
declare function buildMintTokensTransaction<TVersion extends TransactionVersion = "legacy", TFeePayer extends TransactionSigner = TransactionSigner>(args: TransactionBuilderInput<TVersion, TFeePayer> & GetCreateTokenTransactionInput): Promise<FullTransaction<TVersion, TransactionMessageWithFeePayer>>;
 ...
 * ```
 */
declare function buildTransferTokensTransaction<TVersion extends TransactionVersion = "legacy", TFeePayer extends TransactionSigner = TransactionSigner>(args: TransactionBuilderInput<TVersion, TFeePayer> & GetTransferTokensTransactionInput): Promise<FullTransaction<TVersion, TransactionMessageWithFeePayer>>;
...
export { type FetchTokenAccountsConfig, type GetCreateTokenInstructionsArgs, type GetMintTokensInstructionsArgs, type GetTransferTokensInstructionsArgs, type LegacyTokenProgramMonikers, TOKEN_PROGRAM_ADDRESS, type TokenExtensionProgramMonikers, type TokenProgramMonikers, assertIsMint, assertIsSupportedTokenProgram, buildCreateTokenTransaction, buildMintTokensTransaction, buildTransferTokensTransaction, checkedTokenProgramAddress, fetchTokenAccounts, getAssociatedTokenAccountAddress, getCreateTokenInstructions, getMintTokensInstructions, getTransferTokensInstructions, parseTokenProgramAddressOrMoniker, tokenAmountToUiAmount, tokenUiAmountToAmount };
