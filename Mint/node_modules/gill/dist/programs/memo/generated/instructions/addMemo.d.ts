...
import type { Address, AccountMeta, Instruction, InstructionWithAccounts, InstructionWithData, TransactionSigner } from "@solana/kit";
import { MEMO_PROGRAM_ADDRESS } from "../programs";
export type AddMemoInstruction<TProgram extends string = typeof MEMO_PROGRAM_ADDRESS, TRemainingAccounts extends readonly AccountMeta<string>[] = []> = Instruction<TProgram> & InstructionWithData<Uint8Array> & InstructionWithAccounts<TRemainingAccounts>;
...
export declare function parseAddMemoInstruction<TProgram extends string>(instruction: Instruction<TProgram> & InstructionWithData<Uint8Array>): ParsedAddMemoInstruction<TProgram>;
