...
import { Instruction, InstructionWithData, TransactionMessage, Address, AccountMeta, InstructionWithAccounts, TransactionSigner, Option, OptionOrNullable, Encoder as Encoder$1, Decoder as Decoder$1, Codec as Codec$1, ReadonlyUint8Array, GetDiscriminatedUnionVariantContent, GetDiscriminatedUnionVariant, EncodedAccount, Account, MaybeEncodedAccount, MaybeAccount, fetchEncodedAccount, FetchAccountConfig, fetchEncodedAccounts, FetchAccountsConfig, WritableAccount, ReadonlyAccount, ReadonlySignerAccount, AccountSignerMeta, WritableSignerAccount, KeyPairSigner } from '@solana/kit';
...
export { FetchTokenAccountsConfig, GetCreateTokenInstructionsArgs, GetMintTokensInstructionsArgs, GetTransferTokensInstructionsArgs, LegacyTokenProgramMonikers, TOKEN_PROGRAM_ADDRESS, TokenExtensionProgramMonikers, TokenProgramMonikers, assertIsMint, assertIsSupportedTokenProgram, buildCreateTokenTransaction, buildMintTokensTransaction, buildTransferTokensTransaction, checkedTokenProgramAddress, fetchTokenAccounts, getAssociatedTokenAccountAddress, getCreateTokenInstructions, getMintTokensInstructions, getTransferTokensInstructions, parseTokenProgramAddressOrMoniker, tokenAmountToUiAmount, tokenUiAmountToAmount } from './token/index.js';
...
import '../index-M7AUC0es.js';

/**
 * Check if a given instruction is a `SetComputeUnitLimit` instruction
 */
declare function isSetComputeLimitInstruction(instruction: Instruction): instruction is Instruction<typeof COMPUTE_BUDGET_PROGRAM_ADDRESS> & InstructionWithData<Uint8Array>;
/**
 ...
 */
declare function isSetComputeUnitPriceInstruction(instruction: Instruction): instruction is Instruction<typeof COMPUTE_BUDGET_PROGRAM_ADDRESS> & InstructionWithData<Uint8Array>;
/**
...
type AddMemoInstruction<TProgram extends string = typeof MEMO_PROGRAM_ADDRESS, TRemainingAccounts extends readonly AccountMeta<string>[] = []> = Instruction<TProgram> & InstructionWithData<Uint8Array> & InstructionWithAccounts<TRemainingAccounts>;
...
declare function parseAddMemoInstruction<TProgram extends string>(instruction: Instruction<TProgram> & InstructionWithData<Uint8Array>): ParsedAddMemoInstruction<TProgram>;
...
declare function getCreateMetadataAccountV3Instruction<TAccountMetadata extends string, TAccountMint extends string, TAccountMintAuthority extends string, TAccountPayer extends string, TAccountUpdateAuthority extends string, TAccountSystemProgram extends string, TAccountRent extends string, TProgramAddress extends Address = typeof TOKEN_METADATA_PROGRAM_ADDRESS>(input: CreateMetadataAccountV3Input<TAccountMetadata, TAccountMint, TAccountMintAuthority, TAccountPayer, TAccountUpdateAuthority, TAccountSystemProgram, TAccountRent>, config?: {
    programAddress?: TProgramAddress;
}): CreateMetadataAccountV3Instruction<TProgramAddress, TAccountMetadata, TAccountMint, TAccountMintAuthority, TAccountPayer, (typeof input)["updateAuthority"] extends TransactionSigner<TAccountUpdateAuthority> ? ReadonlySignerAccount<TAccountUpdateAuthority> & AccountSignerMeta<TAccountUpdateAuthority> : TAccountUpdateAuthority, TAccountSystemProgram, TAccountRent>;
type ParsedCreateMetadataAccountV3Instruction<TProgram extends string = typeof TOKEN_METADATA_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
    programAddress: Address<TProgram>;
    accounts: {
        /** Metadata key (pda of ['metadata', program id, mint id]) */
...
declare function parseCreateMetadataAccountV3Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<Uint8Array>): ParsedCreateMetadataAccountV3Instruction<TProgram, TAccountMetas>;
...
type ParsedUpdateMetadataAccountV2Instruction<TProgram extends string = typeof TOKEN_METADATA_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
    programAddress: Address<TProgram>;
    accounts: {
        /** Metadata account */
        metadata: TAccountMetas[0];
...
declare function parseUpdateMetadataAccountV2Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<Uint8Array>): ParsedUpdateMetadataAccountV2Instruction<TProgram, TAccountMetas>;
