import { Signature, Commitment, SendTransactionApi, CompilableTransactionMessage, FullySignedTransaction, TransactionWithBlockhashLifetime, BaseTransactionMessage, TransactionMessageWithFeePayer, Rpc, GetEpochInfoApi, GetSignatureStatusesApi, GetLatestBlockhashApi, RpcSubscriptions, SignatureNotificationsApi, SlotNotificationsApi, Transaction, SimulateTransactionApi, DevnetUrl, MainnetUrl, TestnetUrl, createSolanaRpc, createSolanaRpcSubscriptions, RpcFromTransport, SolanaRpcApiFromTransport, RpcTransportFromClusterUrl, SolanaRpcSubscriptionsApi, Address, Base64EncodedWireTransaction, TransactionVersion, TransactionSigner, TransactionMessageWithFeePayerSigner, TransactionMessageWithBlockhashLifetime, GetSignaturesForAddressApi, SignatureBytes, KeyPairSigner, TransactionMessage, ReadonlyUint8Array } from '@solana/kit';
export * from '@solana/kit';
import { S as Simplify, C as CreateTransactionInput, F as FullTransaction } from './index-M7AUC0es.mjs';
...
type SendAndConfirmTransactionWithSignersFunction = (transaction: SendableTransaction, config?: Omit<SendAndConfirmTransactionWithBlockhashLifetimeConfig, "confirmRecentTransaction" | "rpc" | "transaction">) => Promise<Signature>;
 ...
 */
declare function base64BytesToAddress(base64Bytes: string): Address;
/**
 * Takes a base64 encoded string of a byte array, parses, then asserts it as an {@link Signature}
 */
declare function base64BytesToSignature(base64Bytes: string): Signature;
/**
 * Takes a base64 encoded string of a byte array, parses, then returns as a utf8 string
 */
declare function base64BytesToString(base64Bytes: string): string;
 ...
 */
declare function createTransaction<TVersion extends TransactionVersion | "auto", TFeePayer extends TransactionSigner>(props: CreateTransactionInput<TVersion, TFeePayer>): FullTransaction<TVersion extends "auto" ? TransactionVersion : TVersion, TransactionMessageWithFeePayerSigner>;
declare function createTransaction<TVersion extends TransactionVersion | "auto", TFeePayer extends Address>(props: CreateTransactionInput<TVersion, TFeePayer>): FullTransaction<TVersion extends "auto" ? TransactionVersion : TVersion, TransactionMessageWithFeePayer>;
declare function createTransaction<TVersion extends TransactionVersion | "auto", TFeePayer extends TransactionSigner, TLifetimeConstraint extends TransactionMessageWithBlockhashLifetime["lifetimeConstraint"]>(props: CreateTransactionInput<TVersion, TFeePayer, TLifetimeConstraint>): Simplify<FullTransaction<TVersion extends "auto" ? TransactionVersion : TVersion, TransactionMessageWithFeePayerSigner, TransactionMessageWithBlockhashLifetime>>;
declare function createTransaction<TVersion extends TransactionVersion | "auto", TFeePayer extends Address, TLifetimeConstraint extends TransactionMessageWithBlockhashLifetime["lifetimeConstraint"]>(props: CreateTransactionInput<TVersion, TFeePayer, TLifetimeConstraint>): Simplify<FullTransaction<TVersion extends "auto" ? TransactionVersion : TVersion, TransactionMessageWithFeePayer, TransactionMessageWithBlockhashLifetime>>;
declare function createTransaction<TVersion extends TransactionVersion | "auto", TFeePayer extends Address | TransactionSigner, TLifetimeConstraint extends TransactionMessageWithBlockhashLifetime["lifetimeConstraint"]>(props: CreateTransactionInput<TVersion, TFeePayer, TLifetimeConstraint>): Simplify<FullTransaction<TVersion extends "auto" ? TransactionVersion : TVersion, TransactionMessageWithFeePayer, TransactionMessageWithBlockhashLifetime>>;
 ...
 */
declare function getSignatureFromBytes(sigBytes: SignatureBytes): Signature;
...
type PrepareCompilableTransactionMessage = CompilableTransactionMessage | (TransactionMessageWithFeePayer & TransactionMessage);
 ...
 */
declare function lamportsToSol(lamports: bigint | number, decimals?: number): string;
 ...
 * ```
 */
declare function verifySignatureForAddress(address: Address, signature: string | Signature | SignatureBytes | Uint8Array | ReadonlyUint8Array, message: string | Uint8Array): Promise<boolean>;

export { type CreateSolanaClientArgs, CreateTransactionInput, FullTransaction, GENESIS_HASH, GILL_EXTERNAL_MODULE_MAP, type GenericUrl, type GetExplorerLinkArgs, LAMPORTS_PER_SOL, type LocalnetUrl, type ModifiedClusterUrl, type PrepareTransactionConfig, type SendAndConfirmTransactionWithSignersFunction, Simplify, type SimulateTransactionFunction, type SolanaClient, type SolanaClientUrlOrMoniker, type SolanaClusterMoniker, assertKeyPairIsExtractable, base64BytesToAddress, base64BytesToSignature, base64BytesToString, checkedAddress, checkedTransactionSigner, createCodamaConfig, createKeypairFromBase58, createKeypairSignerFromBase58, createSolanaClient, createTransaction, debug, extractBytesFromKeyPair, extractBytesFromKeyPairSigner, generateExtractableKeyPair, generateExtractableKeyPairSigner, getExplorerLink, getMinimumBalanceForRentExemption, getMonikerFromGenesisHash, getOldestSignatureForAddress, getPublicSolanaRpcUrl, getSignatureFromBytes, insertReferenceKeyToTransactionMessage, insertReferenceKeysToTransactionMessage, isDebugEnabled, lamportsToSol, localnet, prepareTransaction, sendAndConfirmTransactionWithSignersFactory, simulateTransactionFactory, transactionFromBase64, transactionToBase64, transactionToBase64WithSigners, verifySignatureForAddress };
